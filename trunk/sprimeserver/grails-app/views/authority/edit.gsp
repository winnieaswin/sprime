...
<%@ page import="sprime.server.Authority" %>
<html>
    <head>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: authorityInstance, field: 'people', 'errors')}">
                                    <g:select name="people" from="${sprime.server.Person.list()}" multiple="yes" optionKey="id" size="5" value="${authorityInstance?.people}" />
                                </td>
                            </tr>
