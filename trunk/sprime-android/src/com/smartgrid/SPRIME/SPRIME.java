 ...
 */
public class SPRIME extends Activity {
	// Debugging
	private static final String TAG = "SPRIME";
	...
	private void setupChat() {
		...
		// events
		mSendButtonOn = (Button) findViewById(R.id.button_on);
		mSendButtonOn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				String message = "1";
				sendMessage(message);
			}
		});
		mSendButtonOff = (Button) findViewById(R.id.button_off);
		mSendButtonOff.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				String message = "0";
				sendMessage(message);
			}
